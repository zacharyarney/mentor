...
hi DiagnosticError guifg=#af5f5f guibg=NONE gui=NONE cterm=NONE
hi DiagnosticWarn guifg=#ffffaf guibg=NONE gui=NONE cterm=NONE
hi DiagnosticInfo guifg=#5fafaf guibg=NONE gui=NONE cterm=NONE
hi DiagnosticHint guifg=#87afd7 guibg=NONE gui=NONE cterm=NONE
hi DiagnosticOk guifg=#87af87 guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi DiagnosticWarn ctermfg=229 ctermbg=NONE cterm=NONE
  hi DiagnosticInfo ctermfg=73 ctermbg=NONE cterm=NONE
  hi DiagnosticHint ctermfg=110 ctermbg=NONE cterm=NONE
...
if s:t_Co >= 16
  ...
  hi DiagnosticInfo ctermfg=cyan ctermbg=NONE cterm=NONE
  hi DiagnosticHint ctermfg=blue ctermbg=NONE cterm=NONE
  hi DiagnosticOk ctermfg=green ctermbg=NONE cterm=NONE
  hi DiagnosticUnderlineError ctermfg=NONE ctermbg=NONE cterm=underline
  hi DiagnosticUnderlineWarn ctermfg=NONE ctermbg=NONE cterm=underline
  hi DiagnosticUnderlineInfo ctermfg=NONE ctermbg=NONE cterm=underline
  hi DiagnosticUnderlineHint ctermfg=NONE ctermbg=NONE cterm=underline
