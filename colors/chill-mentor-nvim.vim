" Name:         chill-mentor-nvim
" Description:  Essentially 'apprentice' by Romain Lafourcade (romainlafourcade@gmail.com)
" Author:       Zachary Arney <zachary.arney@gmail.com>
" Maintainer:   Zachary Arney <zachary.arney@gmail.com>
" Website:      https://github.com/romainl/Apprentice
" License:      MIT
" Last Change:  2025 Jan 31
...
hi clear
let g:colors_name = 'chill-mentor-nvim'

let s:t_Co = has('gui_running') ? -1 : get(g:, 'chill-mentor-nvim_t_Co', get(g:, 't_Co', exists('&t_Co') ? +&t_Co : 0))
...
hi FoldColumn guifg=#6c6c6c guibg=#262626 gui=NONE cterm=NONE
hi Folded guifg=#6c6c6c guibg=#262626 gui=NONE cterm=NONE
hi MatchParen guifg=#ffffaf guibg=#1c1c1c gui=NONE cterm=NONE
hi SignColumn guifg=#6c6c6c guibg=#262626 gui=NONE cterm=NONE
...
hi DiffAdd guifg=#87afd7 guibg=#303030 gui=reverse cterm=reverse
hi DiffChange guifg=#bcbcbc guibg=#303030 gui=reverse cterm=reverse
hi DiffDelete guifg=#ffffaf guibg=#303030 gui=reverse cterm=reverse
hi DiffText guifg=#6c6c6c guibg=#303030 gui=reverse cterm=reverse
...
hi Removed guifg=#af5f5f guibg=NONE gui=NONE cterm=NONE
hi Changed guifg=#5fafaf guibg=NONE gui=NONE cterm=NONE
...
hi Function guifg=#87875f guibg=NONE gui=NONE cterm=NONE
...
hi @variable guifg=#bcbcbc guibg=NONE gui=NONE cterm=NONE
hi DiagnosticError guifg=#af5f5f guibg=NONE gui=italic cterm=italic
hi DiagnosticWarn guifg=#ffffaf guibg=NONE gui=italic cterm=italic
hi DiagnosticInfo guifg=#5fafaf guibg=NONE gui=italic cterm=italic
hi DiagnosticHint guifg=#87afd7 guibg=NONE gui=italic cterm=italic
hi DiagnosticOk guifg=#87af87 guibg=NONE gui=italic cterm=italic
hi DiagnosticUnderlineError guifg=NONE guibg=NONE guisp=#af5f5f gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
hi DiagnosticUnderlineWarn guifg=NONE guibg=NONE guisp=#ffffaf gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
hi DiagnosticUnderlineInfo guifg=NONE guibg=NONE guisp=#5fafaf gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
hi DiagnosticUnderlineHint guifg=NONE guibg=NONE guisp=#87afd7 gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
hi DiagnosticUnderlineOk guifg=NONE guibg=NONE guisp=#87af87 gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
hi NvimInternalError guifg=#af5f5f guibg=#af5f5f gui=NONE cterm=NONE
hi FloatShadow guifg=#bcbcbc guibg=#6c6c6c gui=NONE cterm=NONE
hi FloatShadowThrough guifg=#bcbcbc guibg=#585858 gui=NONE cterm=NONE
hi RedrawDebugClear guifg=NONE guibg=#87875f gui=NONE cterm=NONE
hi RedrawDebugCompose guifg=NONE guibg=#5f875f gui=NONE cterm=NONE
hi RedrawDebugRecompose guifg=NONE guibg=#af5f5f gui=NONE cterm=NONE
...
if !s:italics
  ...
  hi DiagnosticError gui=NONE cterm=NONE
  hi DiagnosticWarn gui=NONE cterm=NONE
  hi DiagnosticInfo gui=NONE cterm=NONE
  hi DiagnosticHint gui=NONE cterm=NONE
  hi DiagnosticOk gui=NONE cterm=NONE
endif
...
if s:t_Co >= 256
  ...
  hi FoldColumn ctermfg=242 ctermbg=235 cterm=NONE
  ...
  hi DiffAdd ctermfg=110 ctermbg=236 cterm=reverse
  hi DiffChange ctermfg=250 ctermbg=236 cterm=reverse
  hi DiffDelete ctermfg=229 ctermbg=236 cterm=reverse
  hi DiffText ctermfg=242 ctermbg=236 cterm=reverse
  ...
  hi Removed ctermfg=131 ctermbg=NONE cterm=NONE
  hi Changed ctermfg=73 ctermbg=NONE cterm=NONE
  hi! link Terminal Normal
  hi! link CursorIM Cursor
  hi! link QuickFixLine Search
  ...
  hi @variable ctermfg=250 ctermbg=NONE cterm=NONE
  hi DiagnosticError ctermfg=131 ctermbg=NONE cterm=italic
  hi DiagnosticWarn ctermfg=229 ctermbg=NONE cterm=italic
  hi DiagnosticInfo ctermfg=73 ctermbg=NONE cterm=italic
  hi DiagnosticHint ctermfg=110 ctermbg=NONE cterm=italic
  hi DiagnosticOk ctermfg=108 ctermbg=NONE cterm=italic
  ...
  hi NvimInternalError ctermfg=131 ctermbg=131 cterm=NONE
  hi FloatShadow ctermfg=250 ctermbg=242 cterm=NONE
  hi FloatShadowThrough ctermfg=250 ctermbg=240 cterm=NONE
  hi RedrawDebugClear ctermfg=NONE ctermbg=101 cterm=NONE
  hi RedrawDebugCompose ctermfg=NONE ctermbg=65 cterm=NONE
  hi RedrawDebugRecompose ctermfg=NONE ctermbg=131 cterm=NONE
  hi! link Number Constant
  hi! link Boolean Constant
  hi! link Character Constant
  hi! link Conditional Statement
  ...
  if !s:italics
    ...
    hi DiagnosticError cterm=NONE
    hi DiagnosticWarn cterm=NONE
    hi DiagnosticInfo cterm=NONE
    hi DiagnosticHint cterm=NONE
    hi DiagnosticOk cterm=NONE
  endif
...
if s:t_Co >= 16
  ...
  hi DiffAdd ctermfg=blue ctermbg=darkgrey cterm=reverse
  ...
  hi DiffText ctermfg=lightgrey ctermbg=darkgrey cterm=reverse
  ...
  hi helpLeadBlank ctermfg=NONE ctermbg=NONE cterm=NONE
  hi helpNormal ctermfg=NONE ctermbg=NONE cterm=NONE
  hi @variable ctermfg=lightgrey ctermbg=NONE cterm=NONE
  hi DiagnosticError ctermfg=darkred ctermbg=NONE cterm=italic
  hi DiagnosticWarn ctermfg=yellow ctermbg=NONE cterm=italic
  hi DiagnosticInfo ctermfg=cyan ctermbg=NONE cterm=italic
  hi DiagnosticHint ctermfg=blue ctermbg=NONE cterm=italic
  hi DiagnosticOk ctermfg=green ctermbg=NONE cterm=italic
  hi DiagnosticUnderlineError ctermfg=NONE ctermbg=NONE cterm=underline
  hi DiagnosticUnderlineWarn ctermfg=NONE ctermbg=NONE cterm=underline
  hi DiagnosticUnderlineInfo ctermfg=NONE ctermbg=NONE cterm=underline
  hi DiagnosticUnderlineHint ctermfg=NONE ctermbg=NONE cterm=underline
  hi DiagnosticUnderlineOk ctermfg=NONE ctermbg=NONE cterm=underline
  hi NvimInternalError ctermfg=darkred ctermbg=darkred cterm=NONE
  hi FloatShadow ctermfg=lightgrey ctermbg=lightgrey cterm=NONE
  hi FloatShadowThrough ctermfg=lightgrey ctermbg=darkgrey cterm=NONE
  hi RedrawDebugClear ctermfg=NONE ctermbg=darkyellow cterm=NONE
  hi RedrawDebugCompose ctermfg=NONE ctermbg=darkgreen cterm=NONE
  hi RedrawDebugRecompose ctermfg=NONE ctermbg=darkred cterm=NONE
  hi! link Number Constant
  hi! link Boolean Constant
  hi! link Character Constant
  hi! link Conditional Statement
