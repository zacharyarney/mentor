...
hi clear
let g:colors_name = 'mentor-nvim'

let s:t_Co = has('gui_running') ? -1 : get(g:, 'mentor-nvim_t_Co', get(g:, 't_Co', exists('&t_Co') ? +&t_Co : 0))
...
hi RedrawDebugComposed guifg=NONE guibg=#5f875f gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi RedrawDebugComposed ctermfg=NONE ctermbg=65 cterm=NONE
...
if s:t_Co >= 16
  ...
  hi RedrawDebugComposed ctermfg=NONE ctermbg=darkgreen cterm=NONE
